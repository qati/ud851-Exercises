...
public class TaskContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        // [Hint] Use selections to delete an item by its row
        int nra = 0;

        switch (sUriMatcher.match(uri)){
            case TASKS:{
                throw new UnsupportedOperationException("Uri not supported for this operation!");
            }
            case TASK_WITH_ID:{
                String id = uri.getPathSegments().get(1);
                nra = db.delete(TaskContract.TaskEntry.TABLE_NAME, "_id=?", new String[]{id});
                break;
            }
        }
