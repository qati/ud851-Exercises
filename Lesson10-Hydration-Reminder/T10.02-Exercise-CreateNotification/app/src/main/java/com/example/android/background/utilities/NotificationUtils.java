...
public class NotificationUtils {
    ...
    private static final int PENDINGINTENT_MAINACTIVITY_ID = 13;
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        notBuilder.setColor(ContextCompat.getColor(context, R.color.colorPrimary))
        ...
        notMan.notify(NOTIFICATION_ID, notBuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context){
        ...
        return PendingIntent.getActivity(context, PENDINGINTENT_MAINACTIVITY_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
